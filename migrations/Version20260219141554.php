 ...
 */
final class Version20260219141554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE type_emploie ADD CONSTRAINT FK_9AE7AE1D4C08A235 FOREIGN KEY (offre_emploie_id) REFERENCES offre_emploie (id)');
